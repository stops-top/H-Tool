        ...
        for(int idx=0; idx<32767; idx++)
         {
           ...
           if(RegEnumValue(hKey, idx, sName, &dwNameLen, NULL, NULL, (LPBYTE)sValue, &dwValueSize)!=ERROR_SUCCESS)break;
           if(*sValue)_PortList->Add(sValue);
         }
...
{
  int iPortNo1 = PortNo(lpList->Strings[Index1]);
  int iPortNo2 = PortNo(lpList->Strings[Index2]);
  ...
  return lpList->Strings[Index1] > lpList->Strings[Index2]; // "DeviceA" - "DeviceB"
}
//---------------------------------------------------------------------------
//////////////////////////// TVictorComm Threads ////////////////////////////
//---------------------------------------------------------------------------

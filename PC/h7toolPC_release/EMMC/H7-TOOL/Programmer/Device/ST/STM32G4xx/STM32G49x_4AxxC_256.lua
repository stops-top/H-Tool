-------------------------------------------------------
-- 文件名 : STM32G49x_4AxxC_256.lua
-- 版  本 : V1.0  2020-04-28
-- 说  明 :
-------------------------------------------------------

print("load \"STM32G49x_4AxxC_256.lua\" ok")
...
function config_cpu(void)
	...
	AlgoFile_OTP   = ""
	AlgoFile_OPT   = "0:/H7-TOOL/Programmer/Device/ST/STM32G4xx/STM32G4xx_CAT4_OPT.FLM"
	AlgoFile_QSPI  = ""
	...
	OB_WRP_VALUE 	 = {0xAA,       0xFF,      0x00,       0xFF,      0x00}		--相与后与此数比较，相等表示没有保护
end

-------------------------------------------------------
-- 文件名 : STM32G47x_48xxE_512.lua
-- 版  本 : V1.0  2020-04-28
-- 说  明 :
-------------------------------------------------------

print("load \"STM32G47x_48xxE_512.lua\" ok")
...
function config_cpu(void)
	...
	AlgoFile_FLASH = "0:/H7-TOOL/Programmer/Device/ST/STM32G4xx/STM32G4xx_512.FLM"	--STM32G4xx_512_Dual.FLM
	AlgoFile_OTP   = ""

-------------------------------------------------------
-- 文件名 : MIMXRT6XX_EVK_FLEXSPI.lua
-- 版  本 : V1.0  2020-04-28
-- 说  明 :
-------------------------------------------------------

print("load \"MIMXRT6XX_EVK_FLEXSPI.lua\" ok")

IncludeList = {
	"0:/H7-TOOL/Programmer/Device/NXP/Lib/RT6xx_Lib.lua"
}
  
function config_cpu(void)
	CHIP_TYPE = "SWD"		--指定器件接口类型: "SWD", "SWIM", "SPI", "I2C", "UART"

	AlgoFile_FLASH = "0:/H7-TOOL/Programmer/Device/NXP/FLM/MIMXRT6XX_EVK_FLEXSPI.FLM"
	AlgoFile_OTP   = ""
	AlgoFile_OPT   = ""
	AlgoFile_QSPI  = ""

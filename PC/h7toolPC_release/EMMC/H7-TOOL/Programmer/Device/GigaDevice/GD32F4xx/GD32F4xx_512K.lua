-------------------------------------------------------
-- 文件名 : GD32F4xx_512K.lua
-- 版  本 : V1.0  2020-04-28
-- 说  明 :
-------------------------------------------------------

print("load \"GD32F4xx_512K.lua\" ok")
...
function config_cpu(void)
	...
	AlgoFile_FLASH = "0:/H7-TOOL/Programmer/Device/GigaDevice/FLM/GD32F4xx_512KB.FLM"
	AlgoFile_OTP   = ""
	AlgoFile_OPT   = ""
	AlgoFile_QSPI  = ""
	...
	OB_SECURE_OFF  = "FF AA FF FF FF FF"	--SECURE_ENABLE = 0时，编程完毕后写入该值(解除加密)
	OB_SECURE_ON   = "FF 00 FF FF FF FF"	--SECURE_ENABLE = 1时，编程完毕后写入该值(芯片加密)

-------------------------------------------------------
-- 文件名 : GD32F10x_XD_3072K.lua
-- 版  本 : V1.0  2020-04-28
-- 说  明 :
-------------------------------------------------------

print("load \"GD32F10x_XD_3072K.lua\" ok")
...
function config_cpu(void)
	...
	AlgoFile_FLASH = "0:/H7-TOOL/Programmer/Device/GigaDevice/FLM/GD32F10x_XD.FLM"
	AlgoFile_OTP   = ""
	AlgoFile_OPT   = ""
	AlgoFile_QSPI  = ""

	FLASH_ADDRESS = 0x08000000		--CPU内部FLASH起始地址
	FLASH_SIZE = 3072 * 1024

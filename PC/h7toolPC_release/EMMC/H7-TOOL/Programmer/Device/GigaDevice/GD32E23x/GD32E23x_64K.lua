-------------------------------------------------------
-- 文件名 : GD32E23x_64K.lua
-- 版  本 : V1.0  2020-04-28
-- 说  明 :
-------------------------------------------------------

print("load \"GD32E23x_64K.lua\" ok")

IncludeList = {
	"0:/H7-TOOL/Programmer/Device/GigaDevice/Lib/GD32E23x_Lib_M4.lua"
}

function config_cpu(void)
	CHIP_TYPE = "SWD"		--指定器件接口类型: "SWD", "SWIM", "SPI", "I2C", "UART"

	AlgoFile_FLASH = "0:/H7-TOOL/Programmer/Device/GigaDevice/FLM/GD32E23x.FLM"
	AlgoFile_OTP   = ""
	AlgoFile_OPT   = ""
	AlgoFile_QSPI  = ""

...
print("load \"HS32F0033.lua\" ok")

IncludeList = {
	"0:/H7-TOOL/Programmer/Device/H-SUN/Lib/HS32F0_Lib.lua"
}

function config_cpu(void)
	CHIP_TYPE = "SWD"		--指定器件接口类型: "SWD", "SWIM", "SPI", "I2C", "UART"

	AlgoFile_FLASH = "0:/H7-TOOL/Programmer/Device/H-SUN/FLM/HS32F0033.FLM"
	AlgoFile_OTP   = ""
	AlgoFile_OPT   = "0:/H7-TOOL/Programmer/Device/H-SUN/FLM/HS32F0_OB.FLM"
	AlgoFile_QSPI  = ""

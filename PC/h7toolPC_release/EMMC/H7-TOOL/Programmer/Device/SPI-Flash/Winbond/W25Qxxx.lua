...
function config_cpu(void)
	DeviceList = {
		...
		"W25Q80",   1 * 1024, 	64 * 1024,  	0xD8,		2000,			0,  
		"W25Q16",   2 * 1024, 	64 * 1024,  	0xD8,		5000,   	0,  
		"W25Q32",   4 * 1024, 	64 * 1024,  	0xD8,		10000,		0,
		"W25Q64",   8 * 1024, 	64 * 1024,  	0xD8,		15000,   	0, 
		"W25Q128",  16 * 1024, 	64 * 1024,  	0xD8,		25000,   	0, 	
		"W25Q256",  32 * 1024, 	64 * 1024,  	0xD8,		80000,   	0, 
	}

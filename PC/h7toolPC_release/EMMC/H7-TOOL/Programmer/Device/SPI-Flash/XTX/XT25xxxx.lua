...
-- 文件名 : XT25xxxx.lua
-- 版  本 : V1.0  2020-11-06
-- 说  明 : 芯片网址 http://www.xtxtech.com/  写速度偏慢
-------------------------------------------------------
function config_cpu(void)
	DeviceList = {
		--器件名称, 容量(KB),   擦除扇区大小,   擦除指令, 	全片擦除超时, 	编程AAI模式(1表示AAI, 0表示page 256写)		     
		"XT25F02",   256, 		64 * 1024,  	0xD8,		2000,   	0,     
		"XT25W02",   256, 		64 * 1024,  	0xD8,		2000,   	0,     
		"XT25F04",   512, 		64 * 1024,  	0xD8,		3000,       0,     
		"XT25W04",   512, 		64 * 1024,  	0xD8,		3000,       0,   
		"XT25F08",   1 * 1024, 	64 * 1024,  	0xD8,		5000,		0,       
		"XT25Q08",   1 * 1024, 	64 * 1024,  	0xD8,		5000,		0,       
		"XT25F16",   2 * 1024, 	64 * 1024,  	0xD8,		6000,       0,     
		"XT25Q16",   2 * 1024, 	64 * 1024,  	0xD8,		6000,       0,     
		"XT25W16",   2 * 1024, 	64 * 1024,  	0xD8,		6000,       0,     
		"XT25Q32",   4 * 1024, 	64 * 1024,  	0xD8,		10000,		0,   
		"XT25W32",   4 * 1024, 	64 * 1024,  	0xD8,		10000,		0,   
		"XT25F64",   8 * 1024, 	64 * 1024,  	0xD8,		20000,   	0,
		"XT25Q64",   8 * 1024, 	64 * 1024,  	0xD8,		20000,   	0,  		
		"XT25F128",  16 * 1024, 64 * 1024,  	0xD8,		45000,   	0,    
		"XT25Q128",  16 * 1024, 64 * 1024,  	0xD8,		45000,   	0,
		"XT25F256",  32 * 1024, 64 * 1024,  	0xD8,		100000,   	0,  		
	}

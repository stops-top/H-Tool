...
function config_cpu(void)
	DeviceList = {
		...
		"M25P05",   64, 		4 * 1024,		0xD8,		2000,   		0,  
		"M25P10",   128, 		4 * 1024,  		0xD8,		2000,   		0,  
		"M25P20",   256, 		4 * 1024,  		0xD8,		2000,   		0,  
		"M25P40",   512, 		4 * 1024,  		0xD8,		4000,       0,  
		"M25P80",   1 * 1024, 	4 * 1024,  		0xD8,		8000,		0,  
		"M25P16",   2 * 1024, 	4 * 1024,  		0xD8,		16000,       0,  
		"M25P32",   4 * 1024, 	4 * 1024,  		0xD8,		32000,		0,
		"M25P64",   8 * 1024, 	4 * 1024,  		0xD8,		64000,   	0, 
		"M25P128",  16 * 1024, 	4 * 1024,  		0xD8,		128000,   	0, 	
	}

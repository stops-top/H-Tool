...
function config_cpu(void)
	DeviceList = {
		...
		"P25Q05",   	64, 	64 * 1024,  	0xD8,		500,		0,   
		"P25Q06",   	64, 	64 * 1024,  	0xD8,		500,		0,   
		"P25Q10",   	128, 	64 * 1024,  	0xD8,		500,		0,   
		"P25Q11",   	128, 	64 * 1024,  	0xD8,		500,		0,   		
		"P25Q20",   	256, 	64 * 1024,  	0xD8,		500,		0,   
		"P25Q21",   	256, 	64 * 1024,  	0xD8,		500,		0,  
		"P25Q40",   	512, 	64 * 1024,  	0xD8,		500,		0,   
		"P25Q80",   	1 * 1024, 	64 * 1024,  	0xD8,		500,		0,  
		"P25Q16",   	2 * 1024, 	64 * 1024,  	0xD8,		500,		0,  		
		"P25Q32",   	4 * 1024, 	64 * 1024,  	0xD8,		500,		0,   
		"P25Q64",   	8 * 1024, 	64 * 1024,  	0xD8,		500,   	0,		
		"P25Q128",  	16 * 1024, 	64 * 1024,  	0xD8,		500,   	0,    
		"P25Q256",  	32 * 1024, 	64 * 1024,  	0xD8,		500,   	0,	 		
	}
...
function pc_default(void)
	...
	if (FLASH_SIZE >= 1024 * 1024) then
		NOTE_PC = string.format("容量 : %d MB  全片擦除速度极快", FLASH_SIZE / (1024 * 1024))
	else
		NOTE_PC = string.format("容量 : %d KB  全片擦除速度极快", FLASH_SIZE / 1024)
	end

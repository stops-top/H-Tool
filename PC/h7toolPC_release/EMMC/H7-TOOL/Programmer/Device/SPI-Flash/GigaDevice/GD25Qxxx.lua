...
function config_cpu(void)
	DeviceList = {
		...
		"GD25Q20",   256, 		64 * 1024,  	0xD8,		500,   		0,  
		"GD25Q40",   512, 		64 * 1024,  	0xD8,		1000,       0,  
		"GD25Q80",   1 * 1024, 	64 * 1024,  	0xD8,		2000,		0,  
		"GD25Q16",   2 * 1024, 	64 * 1024,  	0xD8,		5000,       0,  
		"GD25Q32",   4 * 1024, 	64 * 1024,  	0xD8,		10000,		0,
		"GD25Q64",   8 * 1024, 	64 * 1024,  	0xD8,		16000,   	0, 
		"GD25Q127",  16 * 1024, 64 * 1024,  	0xD8,		50000,   	0, 	
		"GD25Q256",  32 * 1024, 64 * 1024,  	0xD8,		80000,   	0, 
	}

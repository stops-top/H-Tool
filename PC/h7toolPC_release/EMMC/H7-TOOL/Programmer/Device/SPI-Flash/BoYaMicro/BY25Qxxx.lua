...
function config_cpu(void)
	DeviceList = {
		...
		"BY25Q05",   64, 		64 * 1024,		0xD8,		500,   		0,  
		"BY25Q10",   128, 		64 * 1024,  	0xD8,		1000,   		0,  
		"BY25Q20",   256, 		64 * 1024,  	0xD8,		2000,   		0,  
		"BY25Q40",   512, 		64 * 1024,  	0xD8,		4000,       0,  
		"BY25Q80",   1 * 1024, 	64 * 1024,  	0xD8,		10000,		0,  
		"BY25Q16",   2 * 1024, 	64 * 1024,  	0xD8,		10000,       0,  
		"BY25Q32",   4 * 1024, 	64 * 1024,  	0xD8,		8000,		0,
		"BY25Q64",   8 * 1024, 	64 * 1024,  	0xD8,		8000,   	0, 
		"BY25Q128",  16 * 1024, 64 * 1024,  	0xD8,		60000,   	0, 	

		"BY25D05",   64, 		64 * 1024,		0xD8,		500,   		0,  
		"BY25D10",   128, 		64 * 1024,  	0xD8,		1000,   		0,  
		"BY25D20",   256, 		64 * 1024,  	0xD8,		2000,   		0,  
		"BY25D40",   512, 		64 * 1024,  	0xD8,		4000,       0,  
		"BY25D80",   1 * 1024, 	64 * 1024,  	0xD8,		10000,		0,  
		"BY25D16",   2 * 1024, 	64 * 1024,  	0xD8,		10000,       0,  
		"BY25D32",   4 * 1024, 	64 * 1024,  	0xD8,		8000,		0,
		"BY25D64",   8 * 1024, 	64 * 1024,  	0xD8,		8000,   	0, 
		"BY25D128",  16 * 1024, 	64 * 1024,  0xD8,		60000,   	0, 		
	}

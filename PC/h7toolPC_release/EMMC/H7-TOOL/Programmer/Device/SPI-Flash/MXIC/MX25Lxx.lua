...
function config_cpu(void)
	DeviceList = {
		...
		"MX25L10",   128, 		64 * 1024,  	0xD8,		250,   		0,  
		"MX25L20",   256, 		64 * 1024,  	0xD8,		500,   		0,  
		"MX25L40",   512, 		64 * 1024,  	0xD8,		1000,       0,  
		"MX25L80",   1 * 1024, 	64 * 1024,  	0xD8,		2000,		0,  
		"MX25L16",   2 * 1024, 	64 * 1024,  	0xD8,		5000,       0,  
		"MX25L32",   4 * 1024, 	64 * 1024,  	0xD8,		10000,		0,
		"MX25L64",   8 * 1024, 	64 * 1024,  	0xD8,		15000,   	0, 
		"MX25L128",  16 * 1024, 64 * 1024,  	0xD8,		25000,   	0,
		"MX25L256",  32 * 1024, 64 * 1024,  	0xD8,		50000,   	0,
		"MX25L512",  64 * 1024, 64 * 1024,  	0xD8,		100000,   	0,
	}

-------------------------------------------------------
-- 文件名 : AT32F403xG_1024.lua
-- 版  本 : V1.0  2020-04-28
-- 说  明 :
-------------------------------------------------------

print("load \"AT32F403xG_1024.lua\" ok")

IncludeList = {
	"0:/H7-TOOL/Programmer/Device/ArteryTek/Lib/AT32_Lib_E0042000.lua"
}

function config_cpu(void)
	CHIP_TYPE = "SWD"		--指定器件接口类型: "SWD", "SWIM", "SPI", "I2C", "UART"

	AlgoFile_FLASH = "0:/H7-TOOL/Programmer/Device/ArteryTek/FLM/AT32F403_1024.FLM"
	AlgoFile_OTP   = ""
	AlgoFile_OPT   = "0:/H7-TOOL/Programmer/Device/ArteryTek/FLM/AT32F403_UOB.FLM"
	AlgoFile_QSPI  = ""

	AlgoFile_EXT_TYPE1  = "0:/H7-TOOL/Programmer/Device/ArteryTek/FLM/AT32F403_EXT_TYPE1_GENERAL.FLM"
	AlgoFile_EXT_TYPE2  = "0:/H7-TOOL/Programmer/Device/ArteryTek/FLM/AT32F403_EXT_TYPE2_GENERAL.FLM"
	...
	ERASE_CHIP_TIME = 40000		--全片擦除时间ms（仅用于进度指示)

-------------------------------------------------------
-- 文件名 : MM32F0010_16.lua
-- 版  本 : V1.1  2020-12-16 升级OPT算法文件
-- 说  明 : MM32F0010A1T, MM32F0010A1N
-------------------------------------------------------
...
function config_cpu(void)
	...
	OB_SECURE_ON   = "80 FF FF FF FF FF FF FF "	--SECURE_ENABLE = 1时，编程完毕后写入该值
...
function pc_default(void)
	...
	POWEROFF_TIME1 = 200   	--写完OB延迟时间ms
	POWEROFF_TIME2 = 200   	--断电时间ms
